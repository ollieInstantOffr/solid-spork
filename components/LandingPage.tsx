              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs" style={{ color: "var(--muted-foreground)" }}>Partner view for Regine</p>
                  </div>
                </div>
                ...
                <div className="rounded-2xl p-3" style={{ background: "var(--secondary)" }}>
                  <p className="text-xs font-bold mb-2" style={{ color: "var(--muted-foreground)" }}>💌 What Regine needs right now</p>
