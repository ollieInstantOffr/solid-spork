-- AlterTable
ALTER TABLE "PartnerInvite" ADD COLUMN "partnerMessage" TEXT;
...
INSERT INTO "new_User" ("birthDate", "createdAt", "cycleLength", "email", "emailVerified", "hasOnboarded", "id", "image", "name", "periodLength", "phasePreferences", "updatedAt", "wantPregnant") SELECT "birthDate", "createdAt", "cycleLength", "email", "emailVerified", "hasOnboarded", "id", "image", "name", "periodLength", "phasePreferences", "updatedAt", "wantPregnant" FROM "User";
DROP TABLE "User";
